...
let person = {
    ...
    interests: ["sleeping", " screaming", " napping", " drinking coffee", " putting on lip gloss", " girlbossing"],
    greeting: function() {
        // this means this whole object
        alert(`Hello, ${this.name.firstName} ${this.name.lastName}. How are you?`)
        // you can also do it this way
        // alert(`Hello, ${this.name.firstName} ${this["firstName"]["lastName"]}. How are you?`)
    },
    bio: function () {
